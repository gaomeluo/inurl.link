...
// Below-the-fold content for the landing page.
// Lives in its own async chunk: the homepage only downloads this JS once the
// visitor scrolls close to it, so the first screen paints with almost no DOM.
...
<template>
  <div ref="rootEl" class="landing-below">
    <!-- ═══════════ CORE SERVICES ═══════════ -->
...
<style scoped>
/* ════════════════════════════════════════════
   ANIMATABLE ANGLE + KEYFRAMES (below-the-fold only)
   ════════════════════════════════════════════ */
@property --bd-angle {
  syntax: '<angle>';
  inherits: false;
...
.landing-below {
  ...
  align-items: center;
  animation: below-in 0.7s cubic-bezier(0.16, 1, 0.3, 1) both;
}
@keyframes below-in {
...
/* ════════════════════════════════════════════
   FEATURE GRID (kept for consistency)
   ════════════════════════════════════════════ */
.feat-grid {
  display: grid;
